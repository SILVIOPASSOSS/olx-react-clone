...
INSERT INTO "new_Ads" ("createdAt", "description", "id", "price", "priceNegotiable", "title", "updatedAt", "userId", "views") SELECT "createdAt", "description", "id", "price", "priceNegotiable", "title", "updatedAt", "userId", "views" FROM "Ads";
DROP TABLE "Ads";
